...
public class WebsiteSimulator {
    private HashMap<String,String> serialToPhoneNumber = new HashMap<>();
    private HashMap<String, String> serialToSetUp = new HashMap<>();
    private HashMap<String, Stack<String>> serialToResetPins = new HashMap<>();
